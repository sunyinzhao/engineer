		...
		$(document).ready(function() {
			$("#btnExport").click(function(){
				top.$.jBox.confirm("确认要导出申请单吗？","系统提示",function(v,h,f){
					if(v=="ok"){
						$("#searchForm").attr("action","${ctx}/enterprise/auditAndReport/exportAlreadyReportList");
						$("#searchForm").submit();
					}
				},{buttonsFocus:1});
...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/enterprise/auditAndReport/alreadyReportList">单位已上报申请列表</a></li>
	</ul>
	<form:form id="searchForm" modelAttribute="enterpriseWorkers" action="${ctx}/enterprise/auditAndReport/alreadyReportList" method="post" class="breadcrumb form-search">
