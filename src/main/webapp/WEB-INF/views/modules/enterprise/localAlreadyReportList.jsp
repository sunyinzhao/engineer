	...
	<script type="text/javascript">
		$(document).ready(function() {
			$("#btnExport").click(function(){
				top.$.jBox.confirm("确认要导出申请单吗？","系统提示",function(v,h,f){
					if(v=="ok"){
						$("#searchForm").attr("action","${ctx}/enterprise/auditAndReport/exportLocalAlreadyReportList");
						$("#searchForm").submit();
					}
				},{buttonsFocus:1});
        ...
        function lockOver(workersId,personRecordId){
        	...
        	window.location.href = "${ctx}/counselor/examine/tree?recordId="+personRecordId+"&type=3&flag=1";
        }
...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/enterprise/auditAndReport/localReportApplyList">地方已上报申请列表</a></li>
	</ul>
	<form:form id="searchForm" modelAttribute="enterpriseWorkers" action="${ctx}/enterprise/auditAndReport/localReportApplyList" method="post" class="breadcrumb form-search">
