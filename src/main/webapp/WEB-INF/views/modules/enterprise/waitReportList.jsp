...
<head>
	...
	<script type="text/javascript">
        ...
        function lockOver(workersId,personRecordId){
        	...
        	window.location.href = "${ctx}/counselor/examine/tree?recordId="+personRecordId+"&type=1";
        }
...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/enterprise/auditAndReport/waitReportList">单位待上报申请列表</a></li>
	</ul>
	<form:form id="searchForm" modelAttribute="enterpriseWorkers" action="${ctx}/enterprise/auditAndReport/waitReportList" method="post" class="breadcrumb form-search">
