...
<head>
	...
	<script type="text/javascript">
		...
		function applyCfcaExectronicChapter(){
			...
			var url = "${ctx}/cfca/electronicChapter/applyAssociationElectronicChapter?userId=+${cfcaElectronicChapter.userId}";
			$.ajax({
				  type: 'POST',
			      url: url,
			      dataType: 'text',
...
<body>
	...
	<ul class="nav nav-tabs">
		<li class="active"><a href="#">咨询协会电子证书</a></li>
	</ul><br/>
...
--%>
		...
		<%-- 			<form:input path="sequenceNo" htmlEscape="false"  maxlength="100" class="input-medium " readonly="true"/> --%>
			...
			<div class="control-group">
					<center>
						<label  style="width: 300px; font-size:18px; color: #2fa4e7;">暂时没有电子证书!</label>
					</center>
				</div>
			</c:otherwise>
		...
		<div class="form-actions">
			<input id="btnSubmit" class="btn btn-primary" type="button" value="申请电子证书" onclick="applyCfcaExectronicChapter()"/>
		</div>  
