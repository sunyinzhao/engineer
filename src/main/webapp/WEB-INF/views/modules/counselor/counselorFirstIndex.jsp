...
<head>
	...
	<script type="text/javascript">
        ...
        function coverPrint(personRecordId){
        	window.location.href = "${ctx}/counselor/coverPrint/cover?id="+personRecordId+"&declareType="+'1';
        }
        
        function fileCoverPrint(personRecordId){
        	window.location.href = "${ctx}/counselor/coverPrint/fileCover?id="+personRecordId+"&declareType="+'1';
        }
...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="">初始登记</a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="enterpriseWorkers" action="" method="post" class="form-horizontal">
        ...
        <table class="table-form">
            <tr>
                ...
                <td class="tit" height="32px">姓名：</td>
                <td>
            ...
            <tr>
                ...
                <td class="tit" height="38px">证件类型：</td>
                <td>
            ...
            <tr>
                ...
                <td class="tit" height="38px">邮箱：</td>
                <td width="300px">
