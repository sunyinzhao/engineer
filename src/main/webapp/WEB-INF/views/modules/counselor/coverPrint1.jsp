...
<html>
<head>
	<title>咨询工程师(投资)登记申请表-初始登记(封面)</title>
...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="#">咨询工程师(投资)登记申请表-初始登记(封面)</a></li>
	</ul><br/>
							...
							<table class="print-table-form" style="width: 400pt; margin-top: 20pt;  table-layout:fixed;">
								...
								<tr style="height: 200pt;font-family:'FangSong'; color: black;">
									<td style="font-size: 25pt ;line-height: 40pt; text-align: center; " colspan="2"  >
											中 华 人 民 共 和 国<br>咨询工程师（投资）登记申请表<br>（ 初 始 登 记 ）
									</td>
								</tr>
								<tr>
									<td style="" colspan="2">
								...
								<tr>
									<td style="" colspan="2">
										<p style="line-height: 30pt; font-size: 15pt ;text-indent:36pt; font-family:'FangSong'; color: black;">
											申请主专业：${fns:getDictLabel(changeitemCS1.newValue ,"specialty_type" ,"" )}
										</p>
									</td>
								</tr>
								<tr>
									<td style="" colspan="2">
										<p style="line-height: 30pt; font-size: 15pt ;text-indent:36pt; font-family:'FangSong'; color: black;">
											申请辅专业：${fns:getDictLabel(changeitemCS2.newValue  ,"specialty_type" ,"" )}
										</p>
									</td>
								</tr>
								<tr>
