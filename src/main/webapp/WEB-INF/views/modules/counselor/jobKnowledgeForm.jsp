...
<head>
    ...
    <script type="text/javascript">
        ...
        function saveConfirm(){
            ...
            if(confirm("请认真填写，工作简历仅在初次可编辑，确认后将无法再修改")){
                $.ajax({
                    type: 'POST',
                    url: url,
                    data:data,
...
<form:form id="inputForm" modelAttribute="jobKnowledge" action="${ctx}/counselor/self/saveWorkForm?personId=${personId}" method="post" class="form-horizontal">
    ...
    <script type="text/template" id="jobKnowledgeListsTpl">
        <tr  id="jobKnowledgeList{{idx}}">
            ...
            <td width="22%" colspan="3"  >
                ...
                <input id="jobKnowledgeList{{idx}}_personId" name="jobKnowledgeList[{{idx}}].personId" type="hidden" value="{{row.personId}}" maxlength="300" style="width:95%"  />
            ...
            <td class="text-center" width="5%" colspan="1"  >
                ...
                <span id="jobKnowledgeList{{idx}}_delRow" class="close" onclick="delRow(this, '#jobKnowledgeList{{idx}}')" title="删除">
                    <c:if test="${readOnly=='200'}">
                    &times;
                    </c:if>
                </span>
