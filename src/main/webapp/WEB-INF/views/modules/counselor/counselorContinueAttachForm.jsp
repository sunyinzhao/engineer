...
<form:form id="inputForm" modelAttribute="" action="${ctx}/counselor/counselorAttachment/changeSubmit?tableId=${tableId}&recordId=${recordId}&type=4" method="post" class="form-horizontal">
    ...
    <table class="table-form">
       ...
       <%-- <tr>
            ...
            <td colspan="3" width="30%">
                封面《<a  href="../../static/继续登记封面.doc">封面打印模板.doc</a>》
            </td>
            <td colspan="6" width="60%">
            ...
            <td colspan="6" width="60%">
                <div class="control-group" align="left">
                    <div class="controls1">
                        ...
                        <input class="attachmentImageType"    type="hidden"   value="21"/>
                        <ol class="attachmentImageOl" id="title">
                            <c:forEach items="${attachList}" var="attach">
                                <c:if test="${attach.type == '21'}">
            ...
            <td colspan="6" width="60%">
                <div class="control-group" align="left">
                    <div class="controls1">
                        ...
                        <input class="attachmentImageType"    type="hidden"   value="22"/>
                        <ol class="attachmentImageOl" id="retire">
                            <c:forEach items="${attachList}" var="attach">
                                <c:if test="${attach.type == '22'}">
                                    <li id="${attach.id}"> <a href="${ctx}/uploadImage/showImage/id/${attach.id}" target='_blank'  >${attach.fileName}</a> &nbsp;&nbsp;<a href='javascript:' onclick='deleteImageId("${attach.id}",this);'><c:if test="${empty look}">×</c:if></a> </li>
                                </c:if>
                            </c:forEach>
                        </ol>
        ...
        <tr>
            ...
            <td colspan="3" width="30%">
                工作单位法人证书&nbsp;&nbsp;<span style="color: red">(涉及执业登记规程第五条申请人适用)</span>
            </td>
            <td colspan="6" width="60%">
                <div class="control-group" align="left">
                    <div class="controls1">
