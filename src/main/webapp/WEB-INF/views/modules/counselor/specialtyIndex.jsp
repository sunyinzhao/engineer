...
<head>
	...
	<script type="text/javascript">
        ...
        function coverPrint(personRecordId){
        	window.location.href = "${ctx}/counselor/coverPrint/cover?id="+personRecordId+"&declareType="+'3';
        }
        function fileCoverPrint(personRecordId){
        	window.location.href = "${ctx}/counselor/coverPrint/fileCover?id="+personRecordId+"&declareType="+'3';
        }
...
<ul class="nav nav-tabs">
    ...
    <li class="active"><a href="">变更专业登记</a></li>
</ul>
	<form:form id="inputForm" modelAttribute="enterpriseWorkers" action="" method="post" class="form-horizontal">
        ...
        <table class="table-form">
            ...
            <tr>
                ...
                <td style="font-size: 17px">
                    ...
                    <%--<form:input path="registerMainSpecialty" htmlEscape="false" maxlength="100" class="input-xlarge  required" readonly="true"/>--%>
                </td>
                ...
                <td style="font-size: 17px">
                  ...
                  <%-- <form:input path="registerAuxiliarySpecialty" htmlEscape="false" maxlength="100" class="input-xlarge  required" readonly="true"/>&ndash;%&gt;--%>
                   <%-- <c:choose>
        ...
        <%--openFail(examineId,recordId,type){//新增一个窗口,用来查找不通过与不真实的列表--%>
