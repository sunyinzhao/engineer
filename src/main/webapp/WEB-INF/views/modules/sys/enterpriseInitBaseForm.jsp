...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="#">企业注册信息</a></li>
	</ul><br/>


	<form:form id="inputForm" modelAttribute="user" action="${ctx}/sys/enterprise/editUser" method="post" enctype="multipart/form-data" class="form-horizontal">
		<form:hidden path="id"/>
		<form:hidden path="confimFlg" />
		<form:hidden path="password" />
		<%--<form:hidden path="licensePath" />--%>
        <%--<input type="text" name="oldLicenseFile" value="${user.licensePath}">--%>
		<sys:message content="${message}"/>
		<div class="control-group">
			<label class="control-label">原营业执照:</label>
			<div class="controls">
		...
		<div class="control-group">
			...
			<div class="controls">
				<input id="licenseFile" name="licenseFile" type="file" accept=".jpg,.jpeg"   style="width:260px"/>
				<span class="help-inline"><font color="red">*（只支持扩展名为.jpg的图片 营业执照没有问题可以不用再次上传）</font> </span>
				<br/>　　
			</div>
		</div>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:textarea path="reviewMemo" htmlEscape="false" rows="3" maxlength="200" class="input-xlarge" readonly="true"/>
			</div>
		</div>
		...
		<div class="form-actions">
			<c:if test="${user.confimFlg==2}">
			<shiro:hasPermission name="enterprise:enterpriseBase:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="提 交"/>&nbsp;</shiro:hasPermission>
			</c:if>
