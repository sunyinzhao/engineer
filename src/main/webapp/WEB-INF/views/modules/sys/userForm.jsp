...
<head>
	...
	<script src="${pageContext.request.contextPath}/static/webuploader-0.1.5/image-upload/uploadImage.js" type="text/javascript"></script>
...
<body>
	...
	<form:form id="inputForm" modelAttribute="user" action="${ctx}/sys/user/save" method="post" class="form-horizontal">
		...
		<%--<div class="control-group">
			...
			<div class="controls">			
			    <input class="attachmentImagePid"    type="hidden"   name="attachmentId" value="x_123456"/>
				<input class="attachmentImageIds"    type="hidden"  id="attachmentId333" name="attachmentId" value=""/>
				<input class="attachmentImageType"    type="hidden"   value="2"/>
				<ol class="attachmentImageOl" id="attachmentImageOl">
				</ol>		
