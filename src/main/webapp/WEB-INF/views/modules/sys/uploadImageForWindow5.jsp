...
<head>
    ...
    console.log("imageToType"+imageToType);
    console.log("tableType"+tableType);
    console.log("imageIds"+imageIds);
    console.log("imageOl"+imageOl);
    console.log("imagePid"+imagePid);
    console.log("imagePid"+imagePid);
	...
	<script src="${pageContext.request.contextPath}/static/webuploader-0.1.5/image-upload/upload5.js" type="text/javascript"></script>
