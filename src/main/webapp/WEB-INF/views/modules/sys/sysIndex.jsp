...
<head>
	...
	*{padding:0px;margin:0px;}
	.pop {  display: none;  width: 600px; min-height: 300px;  max-height: 750px;  height:420px;  position: absolute;  top: 0;  left: 0;  bottom: 0;  right: 0;  margin: auto;  padding: 25px;  z-index: 130;  border-radius: 8px;  background-color: #fff;  box-shadow: 0 3px 18px rgba(100, 0, 0, .5);  }
	.pop-top{  height:25px;  width:100%;  border-bottom: 1px #E5E5E5 solid; font-size: 25px; }
...
// 	播放声音
	function player(){
		var file = []; 
		file['mp3'] = '${pageContext.request.contextPath}/static/message.mp3'; 
		audioplayer('audioplane', file, false); // 播放 
//			audioplayer('audioplane'); // 停止
		...
		function openMessage( content){
			top.$.jBox.messager(content, "消息", 0, {
	 		    width: 300,
	 		    height: 150,
	 		    showType: 'show'
                /*,
		...
		function gotoB(){			
			...
			obj.document.location="${ctx}/bsservice/bsService/list?status=2&returnType=B";
			obj.src="${ctx}/bsservice/bsService/list?status=2&returnType=B"; 
		}
		//已派工列表
		function gotoC(){
			var obj=window.frames["mainFrame"];
			obj.document.location="${ctx}/bsservice/bsService/list?status=3&returnType=C";
			obj.src="${ctx}/bsservice/bsService/list?status=3&returnType=C";
		}
...
<div class="pop">
    <div class="pop-top">
        <h2 style="font-size: 25px; line-height: 25px;">购买USB KEY</h2>
    ...
    <div class="pop-content">
        ...
        <div class="pop-content-right">
            ...
            <a href="http://59.110.228.64/main" target="_blank">
					<img style="width: 560px; "  alt="" src="${pageContext.request.contextPath}/static/images/cfca.jpg" >
				</a>
	...
	<div id="main">
		<div id="header" class="navbar navbar-fixed-top">
			<div class="navbar-inner">
				<div  style="float: left; margin-right: 1px; margin-left: 0px; width: 275px;">
<%-- 				<span id="productName">${fns:getConfig('productName')}</span> --%>
				<img alt="" src="${pageContext.request.contextPath}/static/images/logoE.png" > 
				<input type="hidden" id="userType" value="${fns:getUser().userType }">
				...
				<ul id="userControl" class="nav pull-right">
					...
					<li id="userInfo" class="dropdown">
						<a class="dropdown-toggle" data-toggle="dropdown" href="#" title="个人信息">您好, ${(fns:getUser().userModel eq '4' and (not empty fns:getUser().originalCompanyName))? fns:getUser().originalCompanyName : fns:getUser().name}&nbsp;<span id="notifyNum" class="label label-info hide"></span></a>
						<%--<ul class="dropdown-menu">
							<li><a href="${ctx}/sys/user/info" target="mainFrame"><i class="icon-user"></i>&nbsp; 个人信息</a></li>
							<li><a href="${ctx}/sys/user/modifyPwd" target="mainFrame"><i class="icon-lock"></i>&nbsp;  修改密码</a></li>
							<li><a href="${ctx}/bsservice/bsService/list?status=3&returnType=C" target="mainFrame"><i class="icon-bell"></i>&nbsp;  我的任务 <span id="notifyNum2" class="label label-info hide"></span></a></li>
						</ul>--%>
					</li>
					...
					<ul id="menu" class="nav" style="*white-space:nowrap;float:none;">
						...
						<c:forEach items="${fns:getMenuList()}" var="menu" varStatus="idxStatus">
							<c:if test="${menu.parent.id eq '1'&&menu.isShow eq '1'}">
								...
								<%--<c:if test="${menu.id ne '025b9c3a715c495db456214fd1350ba2'}">  权限系统中不显示 专家菜单 --%>
...
<%-- 	<embed src="${pageContext.request.contextPath}/static/message.mp3" id="aa" hidden="true"> --%>
</body>
</html>