...
<head>
    ...
    <script type="text/javascript">
        ...
        function page(n,s){
            ...
            if(BatchNo!=""){
                if (resultType != 0){
                $("#searchForm").attr("action","${ctx}/report/datastatistics/compareOpinions?resultType="+resultType+"&declareType=4");
        ...
        function exportData(){
            ...
            if(BatchNo!=""){
                ...
                if (window.confirm("是否确定导出当前数据？")){
                    $("#searchForm").attr("action","${ctx}/report/datastatistics/exportCompareOpinions?resultType="+resultType+"&declareType=4");
                    $("#searchForm").submit();
                }
                }
            }return false;
...
<ul class="nav nav-tabs">
    <li class="active"><a href="${ctx}/report/datastatistics/compareOpinions?declareType=4">继续登记</a></li>
</ul>
