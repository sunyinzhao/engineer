...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $("#searchForm").validate({
                ...
                submitHandler: function(form){
                    ...
                    <%--window.location.href = "${ctx}/report/counselor/findReportCounselorContinueInfo?Type=" + Type + "&batchNo=" + BatchNo;--%>
                    <%--form.action = "${ctx}/report/counselor/findReportCounselorContinueInfo?Type=" + Type ;--%>
                    form.submit();
                },
        ...
        function page(n,s){
            ...
            if(BatchNo!=""){
                if (Type != 0){
                $("#searchForm").attr("action","${ctx}/report/counselor/findReportCounselorContinueInfo?Type="+Type);
                loading('正在为您处理数据，请稍等...');
                $("#searchForm").submit();
            }}
            return false;
        ...
        function exportData(){
            ...
            if(BatchNo!=""){
                ...
                if (window.confirm("是否确定导出当前数据？")){
                    $("#searchForm").attr("action","${ctx}/report/counselor/exportReportCounselorContinueInfoFile?Type="+Type);
                    $("#searchForm").submit();
                }}
            }return false;
        }
...
<ul class="nav nav-tabs">
    <li class="active"><a href="${ctx}/report/counselor/findReportCounselorContinueInfo">继续登记人员</a></li>
</ul>
...
<table id="contentTable" class="table table-striped table-bordered table-condensed">
    ...
    <tr>
        ...
        <th style="text-align: center;" width="80">登记日期</th>
        <th style="text-align: center;" width="100">登记证书编号</th>
        <th style="text-align: center;" width="300">登记执业单位</th>
    </tr>
    </thead>
    <tbody>
    ...
    <c:forEach items="${page.list}" var="reportCounselorCount" varStatus="status">
        <tr>
            ...
            <td>
                <fmt:formatDate value="${reportCounselorCount.declareDate}" pattern="yyyy-MM-dd"/>
            </td>
            <td>
