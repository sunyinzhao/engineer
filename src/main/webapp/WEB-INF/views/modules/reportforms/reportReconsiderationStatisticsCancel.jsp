...
<head>
    ...
    <script type="text/javascript">
        ...
        function page(n,s){
            ...
            if(BatchNo!=""){
                if (Type != 0){
                $("#searchForm").attr("action","${ctx}/report/again/findReconsiderationStatisticsCancelInfo?Type="+Type);
        ...
        function exportData(){
            ...
            if(BatchNo!=""){
                ...
                if (window.confirm("是否确定导出当前数据？")){
                    $("#searchForm").attr("action","${ctx}/report/again/exportReconsiderationStatisticsCancelInfoFile?Type="+Type);
                    $("#searchForm").submit();
                }}
            }return false;
        }
...
<ul class="nav nav-tabs">
    <li class="active"><a href="${ctx}/report/again/findReconsiderationStatisticsCancelInfo">注销登记复核统计</a></li>
</ul>
...
<table id="contentTable" class="table table-striped table-bordered table-condensed">
    ...
    <c:forEach items="${page.list}" var="reportReconsiderationStatistics" varStatus="status">
        <tr>
            ...
            <td>
                    <%--${reportReconsiderationStatistics.registerMainSpecialty}--%>
                    ${fns:getDictLabel(reportReconsiderationStatistics.registerMainSpecialty,"specialty_type","")}
            </td>
            <td>
                    <%--${reportReconsiderationStatistics.registerAuxiliarySpecialty}--%>
                    ${fns:getDictLabel(reportReconsiderationStatistics.registerAuxiliarySpecialty,"specialty_type","")}
            </td>
            <td>
