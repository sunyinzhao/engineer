...
<head>
    ...
    <script type="text/javascript">
        ...
        function page(n,s){
            ...
            if(BatchNo!=""){
                if (resultType != 0){
                $("#searchForm").attr("action","${ctx}/report/datastatistics/compareOpinions?resultType="+resultType+"&declareType=1");
        ...
        function exportData(){
            ...
            if(BatchNo!=""){
                ...
                if (window.confirm("是否确定导出当前数据？")){
                    $("#searchForm").attr("action","${ctx}/report/datastatistics/exportCompareOpinions?resultType="+resultType+"&declareType=1");
                    $("#searchForm").submit();
                }
                }
            }return false;
...
<ul class="nav nav-tabs">
    <li class="active"><a href="${ctx}/report/datastatistics/compareOpinions?declareType=1">初始登记</a></li>
</ul>
...
<table id="contentTable" class="table table-striped table-bordered table-condensed">
    ...
    <tr align="center">
        ...
        <th style="text-align:center;vertical-align:middle;" rowspan="2">申请主专业</th>
        <th style="text-align:center;vertical-align:middle;" rowspan="2">申请辅专业</th>
    ...
    <c:forEach items="${page.list}" var="reportDataStatistics" varStatus="status">
        <tr>
            ...
            <td>
                    ${reportDataStatistics.registerMainSpecialty}
            </td>
            <td>
                    ${reportDataStatistics.registerAuxiliarySpecialty}
            </td>
            <td>
