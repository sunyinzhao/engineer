...
<head>
    ...
    <script type="text/javascript">
        ...
        function page(n,s){
            ...
            if(BatchNo != ""){
                if (Type != 0){
                    $("#searchForm").attr("action","${ctx}/report/counselor/findReportCounselorFirstInfo?Type="+Type);
            ...
            if(BatchNo!=""){
                if (Type != 0){
                    if (window.confirm("是否确定导出当前数据？")){
                        $("#searchForm").attr("action","${ctx}/report/counselor/exportReportCounselorFirstInfoFile?Type="+Type);
                        $("#searchForm").submit();
                    }
                }
            }return false;
...
<ul class="nav nav-tabs">
    <li class="active"><a href="${ctx}/report/counselor/findReportCounselorFirstInfo">初始登记人员</a></li>
</ul>
...
<table id="contentTable" class="table table-striped table-bordered table-condensed">
    ...
    <tr>
        ...
        <th style="text-align: center;" width="200">登记主专业</th>
        <th style="text-align: center;" width="200">登记辅专业</th>
