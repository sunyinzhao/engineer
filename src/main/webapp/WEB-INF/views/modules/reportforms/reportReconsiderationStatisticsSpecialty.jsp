...
<head>
    ...
    <script type="text/javascript">
        ...
        function page(n,s){
            ...
            if(BatchNo!=""){
                if (Type != 0){
                $("#searchForm").attr("action","${ctx}/report/again/findReconsiderationStatisticsSpecialtyInfo?Type="+Type);
        ...
        function exportData(){
            ...
            if(BatchNo!=""){
                ...
                if (window.confirm("是否确定导出当前数据？")){
                    $("#searchForm").attr("action","${ctx}/report/again/exportReconsiderationStatisticsSpecialtyInfoFile?Type="+Type);
                    $("#searchForm").submit();
                }}
            }return false;
        }
...
<ul class="nav nav-tabs">
    <li class="active"><a href="${ctx}/report/again/findReconsiderationStatisticsSpecialtyInfo">变更专业复核统计</a></li>
</ul>
...
<table id="contentTable" class="table table-striped table-bordered table-condensed">
    ...
    <c:forEach items="${page.list}" var="reportReconsiderationStatistics" varStatus="status">
        <tr>
            ...
            <td>
                    ${reportReconsiderationStatistics.originalMajor}
            </td>
            <td>
                    ${reportReconsiderationStatistics.newMainProfessional}
            </td>
            <td>
                    ${reportReconsiderationStatistics.originalAuxiliaryProfession}
            </td>
            <td>
                    ${reportReconsiderationStatistics.newAuxiliaryProfession}
            </td>
            <td>
            ...
            <td>
                    ${reportReconsiderationStatistics.finalFuName}
            </td>
            <td>
                    ${reportReconsiderationStatistics.szResult}
            </td>
            <td>
                    ${reportReconsiderationStatistics.zResult}
            </td>
            <td>
