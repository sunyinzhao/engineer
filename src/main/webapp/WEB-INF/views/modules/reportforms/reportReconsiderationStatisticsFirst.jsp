...
<head>
    ...
    <script type="text/javascript">
        ...
        function page(n,s){
            ...
            if(BatchNo!=""){
                if (Type != 0){
                $("#searchForm").attr("action","${ctx}/report/again/findReconsiderationStatisticsFirstInfo?Type="+Type);
        ...
        function exportData(){
            ...
            if(BatchNo!=""){
                ...
                if (window.confirm("是否确定导出当前数据？")){
                    $("#searchForm").attr("action","${ctx}/report/again/exportReconsiderationStatisticsFirstInfoFile?Type="+Type);
                    $("#searchForm").submit();
                }
                }
            }return false;
...
<ul class="nav nav-tabs">
    <li class="active"><a href="${ctx}/report/again/findReconsiderationStatisticsFirstInfo">初始登记复议统计</a></li>
</ul>
