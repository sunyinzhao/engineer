    ...
    $(function() {
        ...
        uploader = WebUploader.create({
           ...
           // server: '../../server/fileupload.php',
            server: $("#ctx").val()+'/uploadImage/uploader5',
        ...
        */
        uploader.on('uploadSuccess', function(file,response) {
        	...
        	if(fileId.length == 32){
        		//alert(file.name);
        		//alert("上传成功");
        		window.parent.document.getElementById('mainFrame').contentWindow.appendNewImage(fileId,file.name,imageIds,imageOl,imageType);
        	}
