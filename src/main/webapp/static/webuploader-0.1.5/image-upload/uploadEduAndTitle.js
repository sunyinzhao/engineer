(function( $ ){
    ...
    $(function() {
        ...
        uploader = WebUploader.create({
            ...
            chunked: false,
            chunkSize: 512 * 1024,
           // server: '../../server/fileupload.php', $("#ctx").val()+
            server:  '/engineer/a/uploadImage/uploaderEduAndTitle',
        ...
        */
        uploader.on('uploadSuccess', function(file,response) {
        	...
        	if(fileId.length == 32){
        		...
        		window.parent.document.getElementById('mainFrame').contentWindow.appendNewImage(fileId,file.name,imageIds,imageOl);
        	}
