        ...
        //1.Start :添加附件
			...
			function uploadImage(obj,ctx){

                // var innerHTML0 = $(obj).parent().parent()[0].innerHTML;
                ...
                // var typeA = $(obj).parent().find('#type').val();

                // var imagePid = document.getElementById('attachmentImagePid');
                // var imageType = document.getElementById('attachmentImageType');
                // var imageType1 = $($(obj).parent().parent().find(".attachmentImageType")[0]).val(); 	//得到上传图片的类型typd
                ...
                top.$.jBox.open("iframe:"+ctx+"/uploadImage/openWindowEduAndTitle", "上传照片（大小：500KB以内jpg）", 600, 500, {
	                ajaxData:{
                        imagePid :imagePid,
                        imageType:imageType,
                        imageIds:imageIds,
