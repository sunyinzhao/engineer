...
<head>
	...
	body{ 
      ...
      .form-signin{ opacity:0.85; position:relative;text-align:left;width:300px;padding:25px 29px 10px;margin:0 auto 20px;background-color:#fff;border:1px solid #e5e5e5;
...
<!-- 		<img alt="" src=""> -->
		...
		<%-- <div id="themeSwitch" class="dropdown">
		 ...
		 <img alt="" src="${pageContext.request.contextPath}/static/images/logoB.png" style="margin-top: 10px; " >
	</form>
	<div class="footer">
...
Copyright &copy; 2016-${fns:getConfig('copyrightYear')}荧屏（北京）电视技术有限公司
	</div>
