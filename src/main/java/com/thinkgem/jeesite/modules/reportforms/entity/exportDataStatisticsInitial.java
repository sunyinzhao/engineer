 ...
 *
 */
public class exportDataStatisticsInitial  {
	...
	@ExcelField(title="申请主专业", align=2, sort=6)
	...
	@ExcelField(title="申请辅专业", align=2, sort=7)
	...
	public exportDataStatisticsInitial() {
	}

	public exportDataStatisticsInitial(ReportDataStatistics rds) {
		...
		this.registerMainSpecialty = rds.getRegisterMainSpecialty();
		this.registerAuxiliarySpecialty = rds.getRegisterAuxiliarySpecialty();
