 ...
 *
 */
public class ExportApplyPersonNumInfo {
	...
	public ExportApplyPersonNumInfo(){
		super();
	}
	
	public ExportApplyPersonNumInfo(ReportEnterpriseWorkers worker) {
		...
		this.subtotal = worker.getSubtotal();
	 ...
	 * @return the subtotal
	 */
	@ExcelField(title="小计", align=2, sort=5)
	 ...
	 * @return the sign
	 */
	@ExcelField(title="签字", align=2, sort=9)
