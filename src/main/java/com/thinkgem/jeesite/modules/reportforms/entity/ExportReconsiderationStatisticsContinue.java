...
public class ExportReconsiderationStatisticsContinue {
...
//	private String szResult; // 终审辅结论
	...
	@ExcelField(title="终审专家", align=2, sort=9)
	...
	@ExcelField(title="终审结论", align=2, sort=10)
	...
	public ExportReconsiderationStatisticsContinue(ReportReconsiderationStatistics rrs) {
