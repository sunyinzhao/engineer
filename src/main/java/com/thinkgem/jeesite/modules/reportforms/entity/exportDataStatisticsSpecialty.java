 ...
 *
 */
public class exportDataStatisticsSpecialty {
	...
	@ExcelField(title="原主专业", align=2, sort=5)
	...
	@Length(min=0, max=50, message="主专业长度必须介于 0 和 50 之间")
	@ExcelField(title="新主专业", align=2, sort=6)
	...
	@ExcelField(title="原辅专业", align=2, sort=7)
	...
	@Length(min=0, max=50, message="登记辅助专业长度必须介于 0 和 50 之间")
	@ExcelField(title="新辅专业", align=2, sort=8)
	...
	@ExcelField(title="职称", align=2, sort=9)
	...
	@ExcelField(title="专家2姓名", align=2, sort=22)
	...
	@ExcelField(title="专家2结论", align=2, sort=23)
	...
	@ExcelField(title="基本条件原因", align=2, sort=26)
	...
	@ExcelField(title="主专业意见", align=2, sort=27)
	...
	@ExcelField(title="辅专业意见", align=2, sort=28)
	...
	public exportDataStatisticsSpecialty() {
	}

	public exportDataStatisticsSpecialty(ReportDataStatistics rds) {
		...
		this.originalMajor = rds.getOriginalMajor();
		this.newMainProfessional = rds.getNewMainProfessional();
		this.originalAuxiliaryProfession = rds.getOriginalAuxiliaryProfession();
		this.newAuxiliaryProfession = rds.getNewAuxiliaryProfession();
		...
		this.zexpert2Name = rds.getZexpert2Name();
		this.szResult = rds.getSzResult();
		this.zdResult = rds.getZdResult();
		this.baseOpinion = rds.getBaseOpinion();
		this.mainOpinion = rds.getMainOpinion();
		this.auxiliaryOpinion = rds.getAuxiliaryOpinion();
