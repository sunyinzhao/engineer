...
/**
 * 咨询师公示前报表统计信息所需Entity
 *
 */
public class ReportCounselorCount extends DataEntity<ReportCounselorCount> {
	...
	public ReportCounselorCount() {
		super();
		// TODO Auto-generated constructor stub
	}

	public ReportCounselorCount(String id) {
		super(id);
		// TODO Auto-generated constructor stub
	}
...
//	private String companyName; // 执业单位
	...
	public String getFankuiyijian() {
		return fankuiyijian;
	}

	public void setFankuiyijian(String fankuiyijian) {
		this.fankuiyijian = fankuiyijian;
	}
	...
	private String oldWorkers; //原登记执业单位
	private String newWorkers; //现登记执业单位
	private String yuanzhu;  //原登记主专业
	private String yuanfu;  //原登记辅专业
	private String xinzhu;  //变更后登记主专业
	private String xinfu;  //变更后登记辅专业
