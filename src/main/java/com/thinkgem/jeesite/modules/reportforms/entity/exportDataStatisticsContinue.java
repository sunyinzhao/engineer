 ...
 *
 */
public class exportDataStatisticsContinue {
	...
	public exportDataStatisticsContinue() {
	}

	public exportDataStatisticsContinue(ReportDataStatistics rds) {
		...
		this.registerCertificateNum = rds.getRegisterCertificateNum();
