...
public class ZxingHandler {
	...
	public static void main(String[] args) {
		...
		String contents="http://localhost:8080/engineer/enterprise/register";
		int width  = 200;
		int height = 200;
		//String  imgPath=Global.getUserfilesBaseDir()+Global.ENGINEER_BASE_URL+Global.ENGINEER_QR_CODE_URL;
		//工程师附件基础
		String engineerBaseDir = "D:\\engineer\\apply\\engineer\\QRCode";
		File dir = new File(engineerBaseDir);
        System.out.println(engineerBaseDir);
        if(!dir.exists())//目录不存在则创建
            dir.mkdirs();
		
    	String imgPath = FileUtils.path(engineerBaseDir+"7.jpg");
